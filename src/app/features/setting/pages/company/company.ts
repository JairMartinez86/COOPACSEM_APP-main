...
export class CompanyComponent implements OnInit, AfterViewInit, OnDestroy, CanComponentDeactivate {
  ...
  private normalizeCompany(
    ...
    return {
      ...
      AffiliationNavidadAccount: data?.AffiliationNavidadAccount ?? '',
      ...
      .subscribe({
        next: (res: any) => {
          ...
          this.copy = {
            ...
            AffiliationNavidadAccount: apiCompany.affiliationNavidadAccount ?? apiCompany.affiliationNavidadAccount ?? '',
