...
@Component({
  selector: 'app-corriente-table',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './plan-corriente-table.component.html',
  styleUrl: './plan-corriente-table.component.scss'
})
export class PlanCorrienteComponent {
